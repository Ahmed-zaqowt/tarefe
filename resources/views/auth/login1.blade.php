...
<body>
                ...
                <div class="categoriesPopup z-50 bg-white w-4/6 p-5 rounded-md flex justify-between items-start h-96">
                        ...
                        <div
                                ...
                                <a href=""
                                        ...
                                        <img src="../img/461544166_538356362176031_8197690950992023395_n.jpg"
        ...
        <header class="flex flex-col justify-between items-center shadow-md fixed top-0 left-0 right-0 bg-white z-50">
                <div class="container mx-auto  topHeader flex justify-between items-center w-full">
                        <div class="logo">
                                <img src="../img/logo trefe.svg" class="w-40" alt="">
                        </div>
        ...
        <div class="loader z-50 flex justify-center items-center fixed top-0 left-0 bottom-0 right-0 bg-purple-800">
                <img src="../img/logo_trefe_ابيض-removebg-preview.png" width="30%" alt="">
        </div>
        <main class="flex justify-center items-center p-8 my-20">
                <div class="loginCard w-full  lg:w-1/2 md:w-1/2 wow fadeInUp">
                        ...
                        <form action="" method="post">
                                ...
                                <input type="text" class="w-full mt-3 focus:border-purple-800" name="" value="">
                                <button
        ...
        <footer class="bg-purple-800 py-3 px-3 flex flex-col">
                        ...
                        <div class="subscripe bg-white rounded-md p-4 w-full lg:w-1/2">
                                ...
                                <form action="" class="w-full flex flex-col items-center">
                                        <div class="firstInput relative mb-2 w-4/5">
                                                <input type="email"
                                                        class="w-full py-2 px-3 ps-20 border border-purple-800 rounded-md"
                                ...
                                <div class="flex flex-col justify-center items-center">
                                        <div class="follow mt-3">
                                                ...
                                                <div class="flex items-center gap-3 mt-1">
                                                        <a href="" class="text-3xl text-red-600"><i
                                                                        class="fab fa-youtube"></i></a>
                                                        <a href="" class="text-3xl text-blue-800"><i
                                                                        class="fab fa-facebook"></i></a>
                                                        <a href="" class="text-3xl text-purple-800"><i
                                                                        class="fab fa-instagram"></i></a>
                                                        <a href="" class="text-3xl text-blue-900"><i
                                        ...
                                        <div class="payments mt-3">
                                                ...
                                                <div class="flex flex-wrap items-center gap-3 mt-2">
                                                        <img width="40" src="../img/payments/15282719811871317559.webp"
                                                                alt="">
                                                        <img width="40" src="../img/payments/1528273241354964734.webp"
                                                                alt="">
                                                        <img width="40" src="../img/payments/15282732803587566708.webp"
                                                                alt="">
                                                        <img width="40" src="../img/payments/15282732983375743706.webp"
                                                                alt="">
                                                        <img width="40" src="../img/payments/15356946304173589516.webp"
                                                                alt="">
                                                        <img width="40"
                                                                src="../img/payments/161528368123dd7a35ad8708b0dfc74b3630526891.webp"
                                                                alt="">
                                                        <img width="40"
                                                                src="../img/payments/1647843326019ba9fe0ba5d8aedc45cfd968ded649.webp"
                                                                alt="">
                                                        <img width="40"
                                                                src="../img/payments/164811478088870ff20e6c63c81ce2f2166e0dae58.webp"
                                                                alt="">
                                                        <img width="40"
                                                                src="../img/payments/17193084623789a558f934389f07b55391e120d31a.png"
                                                                alt="">
                                                </div>
                                        </div>
                                </div>
                ...
                <div class="copyright text-center container mx-auto mt-3">
                        <p class="text-white">&copy; 2024 <a href="https://yourwebsite.com"
                                        class="text-gray-300">الطريفي</a>. جميع الحقوق محفوظة.</p>
