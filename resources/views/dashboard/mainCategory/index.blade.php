...
@section('title', 'لوحة تحكم الطريفي مول | الأقسام الرئيسية')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="color: " id="exampleModalLabel">اضافة قسم رئيسي جديد</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="form_add" id="form_add" enctype="multipart/form-data"
                        action="{{ route('dash.maincat.store') }}" method="POST">
                        @csrf
                        <div class="mb-2 form-group">
                            <label class="form-label">@lang('اسم القسم الرئيسي')</label>
                            <input placeholder="@lang('اسم القسم الرئيسي')" name="name" class="form-control" type="text">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="mb-2 form-group">
                            <label class="form-label">@lang(' صورة المنتج الرئيسية')</label>
                            <input id="company-logo-input" name="image" class="form-control" type="file">
                            <div class="invalid-feedback"></div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form_edit" id="form_edit" enctype="multipart/form-data"
                        action="{{ route('dash.maincat.update') }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="id" class="form-control">
                        <div class="mb-2 form-group">
                            <label class="form-label">اسم القسم الرئيسي</label>
                            <input id="edit_name" placeholder="اسم القسم الرئيسي" name="name" class="form-control"
                                type="text">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="mb-2 form-group">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <label class="form-label">@lang('اسم القسم الرئيسي')</label>
                            <input placeholder="@lang('اسم القسم الرئيسي ')" class="form-control search_input" data-ajax="true" data-url="{{ route('dash.maincat.search.name') }}" type="text" id="search_name">
                            <div class="suggestions" id="search_name_suggestions"></div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-12">
                            <label class="form-label">@lang('اسم القسم الفرعي')</label>
                            <input placeholder="@lang('اسم القسم الفرعي ')" class="form-control search_input" data-ajax="true" data-url="{{ route('dash.subcat.search.name') }}" type="text" id="search_sub">
                            <div class="suggestions" id="search_sub_suggestions"></div>
                        </div>
        ...
        <div class="col-12 col-lg-12 col-xl-12 d-flex">
            <div class="card radius-10 w-100">
                <div class="card-header bg-transparent">
                    <div class="row g-3 align-items-center">
                        <div class="col">
                            <h5 class="mb-0">@lang('الأقسام الرئيسية')</h5>
                        </div>
                        <div class="col">
                        ...
                        <table id="datatable" class="table align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th>#</th>
                                    <th>@lang('  الصورة ')</th>
                                    <th>@lang('  القسم الرئيسي')</th>
                                    <th>@lang('الاقسام المتفرعة منه')</th>
                                    <th>@lang('العمليات')</th>
                                </tr>
                            </thead>
                        </table>
...
@section('js')
    <script>
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: "{{ route('dash.maincat.getdata') }}",
                data: function(d) {
                    d.name = $('#search_name').val();
                    d.sub = $('#search_sub').val();
                }
            },
